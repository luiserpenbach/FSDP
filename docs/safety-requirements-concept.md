...
Status: proposal (2026-09-11). Phases A–D implemented (2026-09-12); see `docs/implementation.md` and `docs/safety-testing-guide.md`. Implementation plan: [safety-requirements-implementation-plan.md](safety-requirements-implementation-plan.md).
